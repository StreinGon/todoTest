...
const singIn = (req, res, next) => {
    passport.authenticate('local', (err, user, info) => {
        ...
        if (!user) {
            return customResponse(res, 400, constants.statusConstants.LOGIN_INCORRECT);
        }
...
const singUp = (req, res) => {
    ...
    return newRole.save((err) => {
        ...
        return userServices
            ...
            return customResponse(res, 200, constants.statusConstants.REDISTRATION_SUCCESSFULL);
        });
    });
};
